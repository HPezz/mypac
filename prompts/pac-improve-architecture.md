...
Resolve forge targets through `gh` or `glab` using explicit URL, tracking remote, then `origin` precedence; load `skills/pac-gitlab/SKILL.md` only for GitLab. Read and follow `skills/pac-improve-architecture/SKILL.md`.
