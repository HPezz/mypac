...
test("loadSkillFromPath: loads a valid skill and strips frontmatter", async (t) => {
...
test("loadSkillFromPath: returns null when the file is missing", async (t) => {
...
test("loadSkillFromPath: returns null for an empty file", async (t) => {
...
test("loadSkillFromPath: exposes raw frontmatter and stripped content separately", async (t) => {
