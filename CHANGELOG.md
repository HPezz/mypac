...
- Added first-class mise tasks that install checkout dependencies and build or validate upload-ready ChatGPT Agent Skills packages. ([#451](https://github.com/ladislas/mypac/issues/451))
