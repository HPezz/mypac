...
- Phased bootstrap around mise-managed Node, npm, and uv foundation tools, with pre-mutation mise integration checks and explicit Pi runtime compatibility verification. ([#431](https://github.com/ladislas/mypac/issues/431))
